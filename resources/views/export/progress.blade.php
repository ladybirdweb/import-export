            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12 import-msg-container hidden">
                        <h3>Export process completed</h3>
                        <div id="message">
                            <a class="btn btn-success" id="downloadExport" href="">Download</a>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function() {
        var loop = setInterval(function() {
            $.ajax({
                url: '{{ route('ladybirdweb.export.ajax.progress', $id) }}'
            })
            .done(function(response) {
                ...
                if ( response.progress == 100 ) {
                    clearInterval( loop );
                    $('#message #downloadExport').attr( 'href', response.exported );
